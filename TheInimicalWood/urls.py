...
from. views import home, game, create_character, Overview, specialthanks, delete_character, Shop, mission_select, briefing
...
urlpatterns = [
    ...
    path('briefing/<int:id>', briefing, name="briefing")
]